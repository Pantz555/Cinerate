...
type Props = {
  recentlyRatedMoviesProp: Preloaded<
    typeof api.movies.getUserRecentlyRatedMovies
  >;
  preloadedTrendingMovies: Preloaded<typeof api.movies.getTrendingMovies>;
};

export default function HomePageContent({
  recentlyRatedMoviesProp,
  ...
  // Use paginated query for filtered movies
  ...
  const recentlyRatedMovies = usePreloadedQuery(recentlyRatedMoviesProp);

  // Fetch trending movies
  const trendingMovies = usePreloadedQuery(preloadedTrendingMovies);
  ...
  // Build query params for View All link
  const getViewAllUrl = (type: "search" | "recentlyRated" | "trending") => {
    ...
    } else if (type === "recentlyRated") {
      params.set("sortBy", "recentlyRated");
    } else if (type === "trending") {
      params.set("sortBy", "trending");
    }

    return `/movies/all?${params.toString()}`;
  };
            ...
            <div className="mt-10">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-2">
                  ...
                  {!debounced.trim() && moviesLength > 4 && hasFilters && (
                    <Button
                      className="bg-purple-600 hover:bg-purple-700 text-white"
                      asChild
                    >
                      <Link href={getViewAllUrl("search")}>
                        View All
              ...
              (!debounced.trim() && paginationStatus === "LoadingFirstPage") ? (
            ...
            <div className="flex flex-col gap-8 mt-10">
              ...
              <section>
                <div className="flex items-center justify-between mb-4">
                  ...
                  {trendingMovies && trendingMovies.length > 4 && (
                    <Button
                      className="bg-purple-600 hover:bg-purple-700 text-white"
                      asChild
                    >
                      <Link href={getViewAllUrl("trending")}>
                        View All
                        <ChevronRight className="ml-2 h-4 w-4" />
                      </Link>
                    </Button>
